...
function initFirebase() {
  ...
  try {
    ...
    if (process.env.FIREBASE_SERVICE_ACCOUNT) {
      ...
      projectId  = serviceAccount.project_id; // extract from JSON
      ...
      console.warn('[Firebase] No credentials found — Firestore disabled, using local JSON fallback.');
      initialized = true; // prevent repeated warnings
      return null;
    }
