/**
 * BAJAJ PEST CONTROL — Email Service
 * Priority: Resend → SendGrid → Nodemailer (Gmail SMTP)
 */
...
// Lazy-load Resend only if key is present
function getResend() {
...
async function sendViaResend({ to, subject, html }) {
  ...
  const from = process.env.RESEND_FROM_EMAIL ||
               ...
               'Bajaj Pest Control <onboarding@resend.dev>';
